...
@section('title', 'Tambah Jadwal - Campus Queue')
...
<main class="pt-24 pb-12 px-8 max-w-3xl mx-auto">
    <header class="mb-10">
        ...
        <h1 class="font-h1 text-h1 text-on-surface">Tambah Jadwal Baru</h1>
        <p class="text-on-surface-variant font-body-lg">Tentukan waktu operasional untuk layanan.</p>
    </header>
        ...
        <form action="{{ route('admin.jadwal.store') }}" method="POST">
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <input type="date" name="tanggal" id="tanggal" class="w-full px-4 py-3 rounded-xl border border-emerald-100 focus:ring-2 focus:ring-primary focus:border-transparent transition-all" required value="{{ old('tanggal') }}">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="time" name="jam_mulai" id="jam_mulai" class="w-full px-4 py-3 rounded-xl border border-emerald-100 focus:ring-2 focus:ring-primary focus:border-transparent transition-all" required value="{{ old('jam_mulai') }}">
                    ...
                    <div>
                        ...
                        <input type="time" name="jam_selesai" id="jam_selesai" class="w-full px-4 py-3 rounded-xl border border-emerald-100 focus:ring-2 focus:ring-primary focus:border-transparent transition-all" required value="{{ old('jam_selesai') }}">
                ...
                <div>
                    ...
                    <input type="number" name="kuota" id="kuota" class="w-full px-4 py-3 rounded-xl border border-emerald-100 focus:ring-2 focus:ring-primary focus:border-transparent transition-all" placeholder="Contoh: 50" required value="{{ old('kuota') }}">
